...
for thispath in all_paths: #choose first path from paths in excel sheet
    ...
    firstmet = thispath_temp[1]
    secondmet = thispath_temp[2] 
    thispath_firstmet = "|".join([origin, firstmet, secondmet]) 
    ...
    for site1 in top_sites: #iterating thru all met sites to choose comparison path
        for site2 in top_sites:
            thatpath = "|".join([origin,site1,site2,thirdmet]) #choose comparison path
            thatpath_firstmet = "|".join([origin,site1,site2])      
...
with open('/Users/Confetti/Documents/Research/listvary1and2/Vary1and2_OR_Paths_MDA.csv', 'wb') as f: #CHANGE
    writer = csv.writer(f, delimiter=',')
    for key in or_arr:
        writer.writerow(key)

with open('/Users/Confetti/Documents/Research/listvary1and2/Vary1and2_AOR_Paths_MDA.csv', 'wb') as f: #CHANGE
    writer = csv.writer(f, delimiter=',')
