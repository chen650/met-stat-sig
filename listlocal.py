...
for thispath in all_paths: #choose first path from paths in excel sheet
    ...
    temp = [temp[0], \
        temp[1], temp[2]] #truncate to origin and 2 mets
    thispath = "|".join([temp[0], temp[1], temp[2]])
    origin = temp[0]
    firstmet = "|".join([origin, temp[1]]) 
...
with open('/Users/Confetti/Documents/Research/listlocal/Local_Paths_HCV.csv', 'wb') as f: #CHANGE
