...
"""
Breast -> 1st site -> vary 2nd -> end site
"""
...
thispath = ('Breast|LN (dist)|Bone|Brain')
...
for site in all_sites:
    thatpath = "|".join([thispath_fs,site,thispath_fe]) #[0:3]
    thatpath_firstmet = "|".join([thispath_fs,site]) #[0:2]
    for path in all_paths:
